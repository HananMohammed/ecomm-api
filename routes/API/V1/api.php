...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('product-delivery', 'ProductController@updateStatus');
    ...
    Route::post('wallet-complete-order', 'OrderController@store');
    Route::get('get-drivers', 'OrderController@getDrivers');
    Route::post('assign-order-to-driver', 'OrderController@assignOrdersToDelivery');

    //wallet
    Route::post('/wallet-deposits', 'WalletController@walletDeposit');
    Route::post('/wallet-transfer', 'WalletController@walletTransfer');
    Route::get('/my-wallet-details', 'WalletController@walletDetails');
});
